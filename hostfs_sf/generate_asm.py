...
# hardcoded currently, none other exist
region = 'usa'
...
thunk_header_template = env.get_template('thunk_header.jinja2')
thunk_template = env.get_template('thunk.jinja2')

with open(sys.argv[1], 'w') as asmFile:
    asmFile.write('; This file is generated. DO NOT MODIFY IT!\n')
